...
from ..extractors.nested_extractor import create_extractor, PathExtractor
...
class RoleConfig:
    ...
    mapping: Dict[str, List[str]] = field(default_factory=lambda: {
...
class TrackerConfig:
    ...
    extractors: Dict[str, Union[str, List[str], dict]] = field(default_factory=dict)
    
    # What to track
    track_operations: bool = True
    track_messages: bool = True
    track_custom_fields: List[str] = field(default_factory=list)
