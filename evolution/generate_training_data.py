...
EXAMPLES OF GOOD TRAINING DATA STRUCTURE:

For a content generation function like generate_essay(topic, tone, length):
[
    {{"topic": "climate change", "tone": "informative", "length": 500}},
    {{"topic": "artificial intelligence ethics", "tone": "persuasive", "length": 800}},
    ...
]

For a classification function like classify_intent(text):
[
    {{"text": "What's the weather like?", "expected_output": "weather_query"}},
    {{"text": "Book a flight to Paris", "expected_output": "booking_request"}},
    ...
]
